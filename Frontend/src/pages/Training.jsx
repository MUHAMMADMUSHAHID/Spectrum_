...
export default function Training() {
  ...
  const methodologiesRight = ["5S", "FMEA", "APQP", "Quality Plan", "TQM"];
    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="relative h-[350px] flex items-center">
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#002C66] dark:text-white">
      ...
      <section className="">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-2xl  text-gray-700 dark:text-gray-300">
            Spectrum provides a wide range of Training Programs in all major
            standards for Lead Auditors, Internal Auditors, and staff awareness.
            <br />
            Our engaging workshops ensure your team is equipped to maintain and
      ...
      <section className="pb-24 pt-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="rounded-3xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-8 shadow-sm">
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-2xl bg-[#032d6a] flex items-center justify-center">
                  <BookOpen className="text-white w-7 h-7" />
                </div>

                <h2 className="text-2xl lg:text-3xl font-bold text-[#032d6a] dark:text-white">
                  Training Objectives
                </h2>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                {objectives.map((item, index) => (
                  <span
                    key={index}
                    className="rounded-full border border-gray-300 dark:border-gray-600 px-4 py-1.5 text-sm font-medium bg-white dark:bg-gray-900 text-[#032d6a] dark:text-white"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div className="rounded-3xl border border-amber-200 dark:border-amber-700 bg-amber-50/40 dark:bg-gray-800 p-8 shadow-sm">
              <div className="flex items-center gap-4">
              ...
              <p className="mt-4 text-base leading-7 text-gray-700 dark:text-gray-300">
                Including managers, supervisors, engineers, quality
                professionals and operational staff who influence product or
                service quality.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="rounded-3xl bg-[#032d6a] p-12 text-center shadow-xl">
            ...
            <p className="mt-6 text-lg text-blue-100 leading-8">
              ...
              continual improvement. Our experienced trainers deliver practical
              sessions tailored to your business needs.
            </p>
